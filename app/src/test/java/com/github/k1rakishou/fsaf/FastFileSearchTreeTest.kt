...
class FastFileSearchTreeTest {
    ...
    fun `test insert many unique nodes`() {
        ...
        assertEquals(FastFileSearchTreeNode.LEAF, children["0"]!!.getCurrentChildren()["00"]!!.getCurrentChildren()["000.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["1"]!!.getCurrentChildren()["11"]!!.getCurrentChildren()["111.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["2"]!!.getCurrentChildren()["22"]!!.getCurrentChildren()["222.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["3"]!!.getCurrentChildren()["33"]!!.getCurrentChildren()["333.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["4"]!!.getCurrentChildren()["44"]!!.getCurrentChildren()["444.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["5"]!!.getCurrentChildren()["55"]!!.getCurrentChildren()["555.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["6"]!!.getCurrentChildren()["66"]!!.getCurrentChildren()["666.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["7"]!!.getCurrentChildren()["77"]!!.getCurrentChildren()["777.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["8"]!!.getCurrentChildren()["88"]!!.getCurrentChildren()["888.txt"]!!.getCurrentNodeName())
        assertEquals(FastFileSearchTreeNode.LEAF, children["9"]!!.getCurrentChildren()["99"]!!.getCurrentChildren()["999.txt"]!!.getCurrentNodeName())
